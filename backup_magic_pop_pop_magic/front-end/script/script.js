...
$(document).ready(() => {
    ...
    $("#accordion").accordion({ 
        ...
        const set_button = (buy_button_name, display_num_name) => {
          ...
          //  buy_button_value = localStorage.getItem(buy_button_name);
        ...
        const load_cart = () => {
            ...
            /*
            let item_1 = localStorage.getItem("buy_button_1");
            let item_2 = localStorage.getItem("buy_button_2");
            let item_3 = localStorage.getItem("buy_button_3");
            let item_4 = localStorage.getItem("buy_button_4");
            let item_5 = localStorage.getItem("buy_button_5");
            let item_6 = localStorage.getItem("buy_button_6");
            let total_items = 0;

            if (item_1 != null ) {

                $("#buy_button_1").text('remove');
                $("#buy_button_1").prepend('<i class="fa fa-shopping-cart"></i> ');
                $("#buy_button_1").val("remove");
                $("#display_num_1").text(parseInt(item_1));
                total_items = total_items + parseInt(item_1);
            }
        ...
        $(".buy_button").click((evt) => {
            ...
            if (the_value_evt != "remove") {
                ...
                $(`#${the_id_evt}`).text('add');
                $(`#${the_id_evt}`).prepend('<i class="fa fa-shopping-cart"></i> ');
                //alert(evt.currentTarget.nextElementSibling.innerText);
                //alert($(`#${the_num_value.id} .display_num`).innerText);
